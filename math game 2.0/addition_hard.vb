...
Public Class addition_hard
    ...
    Private Sub addition_hard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        welcome.Text = "Welcome to the maths game, " & GlobalVariables.player_name & "! You selected Hard Addition."
        Randomize()
    ...
    Private Sub submit_btn_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Else
            ...
            dr.Item("player_name") = GlobalVariables.player_name.ToUpper()
