...
Imports System.IO
Public Class multiplication_hard
    ...
    Private Sub multiplication_hard_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Timer1.Start()

        pfc.AddFontFile("fonts/ethnocentric.ttf")
        pfc.AddFontFile("fonts/aroma-light.ttf")

        welcome.Text = "Welcome to the maths game, " & GlobalVariables.player_name & "! You selected Hard Multiplication."
        Randomize()
        ...
        dataTableScoreDetail.TableName = "hard_m"
        dataTableScoreDetail.ReadXml("highscores/hard_m.xml")
    ...
    Private Sub submit_btn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles submit_btn.Click
        ...
        Else
            ...
            'Try [FOR TESTING]
            dataTableScoreDetail.TableName = "hard_m"
            dataTableScoreDetail.WriteXml("highscores/hard_m.xml")
            'Catch ex As Exception
